...
var KTTypeahead = function () {
    function APICall() {
        fetch("http://localhost:5000/admin/society/api")
            .then(response => {
            ...
            .catch(error => console.log("Si è verificato un errore su API gestori! - " + error));
    }
    ...
    var demo1 = function () {
        ...
        $('#kt_typeahead_1, #kt_typeahead_1_modal, #kt_typeahead_1_validate, #kt_typeahead_2_validate, #kt_typeahead_3_validate').typeahead({
            ...
            name: 'states',
            source: substringMatcher(APICall())
        });
    }
    ...
    return {
        ...
        init: function () {
            demo1();
            console.log('gestori 1 inizializzata')
            demo2();
            demo3();
            demo4();
            demo5();
